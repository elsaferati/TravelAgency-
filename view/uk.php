...
<body>
    <header>
        ...
        <div class="burger-menu">
            <button onclick="openMenu()"><img class="burget-icon" src="../public/images/burger.jpg"
    ...
    <main>
        <section id="first-section">
            <ul>
                <li id="first-img">
                    <img src="../public/images/uk1.jpg" alt="uk">
                </li>
                <li>
                    <img src="../public/images/uk2.jpg" alt="uk">
                </li>
            </ul>
        </section>
        ...
        <section id="third-section">
            ...
            <ul>
                <li>
                    <img src="../public/images/uk3.webp" alt="uk">
                    <div>
                ...
                <li>
                    <img src="../public/images/uk4.webp" alt="uk">
                    <div>
                        <h2>Durance</h2>
                ...
                <li>
                    <img src="../public/images/uk5.webp" alt="uk">
                    <div>
                        <h2>La Fontaine</h2>
