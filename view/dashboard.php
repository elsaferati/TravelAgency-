...
<body>
    <div class="dashboard-container">
        <div class="dashboard-header">
            ...
            <a href="../controller/logout.php" class="dashboard-btn">Log Out</a>
        </div>
        ...
        <div class="actions">
            <a href="../view/edit-profile.php?user_id=<?php echo $user->getId(); ?>" class="dashboard-btn">Edit Profile</a>
            <a href="../view/delete-profile.php?user_id=<?php echo $user->getId(); ?>" class="delete">Delete Account</a>
        </div>
    </div>
</body>
</html>
