...
if (isset($_GET['Id'])) {  // Use 'Id' to match the database column name
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $id = $_POST['Id'];  // Use 'Id' for POST data to match the database column name
...
<form method="POST" action="editBooking.php">
    <input type="hidden" name="Id" value="<?= isset($bookingDetails['Id']) ? htmlspecialchars($bookingDetails['Id']) : '' ?>">  <!-- Use 'Id' here -->
